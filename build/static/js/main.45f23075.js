/*! For license information please see main.45f23075.js.LICENSE.txt */
!(function () {
  "use strict";
  var e = {
      463: function (e, n, t) {
              ...
              (function (e, n, t, r, l) {
                switch (n) {
                  ...
                  case "pointerover":
                    var a = l.pointerId;
                    return (
                      Ln.set(a, Fn(Ln.get(a) || null, e, n, t, r, l)),
                      !0
                    );
                  case "gotpointercapture":
                    return (
        ...
        function gs(e, n) {
          ...
          if ((wa(), (zi = t), (Ci.current = r), null !== Oi))
            throw Error(a(261));
        ...
        function ws(e) {
          ...
          do {
            ...
            if (((e = n.return), 0 === (32768 & n.flags))) {
              ...
              if (null === e) return ((Ii = 6), void (Oi = null));
  ...
  !(function () {
    ...
    function c(e) {
      ...
      return (0, s.jsx)("button", {
        onClick: function () {
          return n({ type: d.ADD_DIGIT, payload: { digit: t } });
        },
        children: t,
      });
    }
    function f(e) {
      ...
      return (0, s.jsx)("button", {
        onClick: function () {
          return n({ type: d.CHOOSE_OPERATION, payload: { operation: t } });
        },
        children: t,
      });
    }
    ...
    function p(e, n) {
      ...
      switch (t) {
        case d.ADD_DIGIT:
          return e.overwrite
            ? i(i({}, e), {}, { currentOperand: r.digit, overwrite: !1 })
            : "." === r.digit || "," === r.digit
              ? e.currentOperand && e.currentOperand.includes(".")
                ? e
                : i(
                    i({}, e),
                    {},
                    {
                      currentOperand: ""
                        .concat(e.currentOperand || "0")
                        .concat(r.digit),
                    },
                  )
              : ("." === r.digit && e.currentOperand.includes(".")) ||
                  ("0" === r.digit && "0" === e.currentOperand)
                ? e
                : i(
                    i({}, e),
                    {},
                    {
                      currentOperand: ""
                        .concat(e.currentOperand || "")
                        .concat(r.digit),
                    },
                  );
        case d.CHOOSE_OPERATION:
          return null == e.currentOperand && null == e.previousOperand
            ? e
            : null == e.currentOperand
              ? i(i({}, e), {}, { operation: r.operation })
              : null == e.previousOperand
                ? i(
                    i({}, e),
                    {},
                    {
                      operation: r.operation,
                      previousOperand: e.currentOperand,
                      currentOperand: null,
                    },
                  )
                : i(
        ...
        case d.DELETE_DIGIT:
          return e.overwrite
            ? i(i({}, e), {}, { overwrite: !1, currentOperand: null })
            : null == e.currentOperand
              ? e
              : 1 === e.currentOperand.length
                ? i(i({}, e), {}, { currentOperand: null })
                : i(
                    i({}, e),
                    {},
                    { currentOperand: e.currentOperand.slice(0, -1) },
                  );
        case d.EVALUATE:
          return null == e.operation ||
            null == e.currentOperand ||
            null == e.previousOperand
            ? e
            : i(
    ...
    var h = new Intl.NumberFormat("en-us", { maximumFractionDigits: 0 });
    function v(e) {
      if (null != e) {
        var n = l(e.split("."), 2),
          t = n[0],
          r = n[1];
        return null == r ? h.format(t) : "".concat(h.format(t), ".").concat(r);
      }
    }
    var g = function () {
      var n = l((0, e.useReducer)(p, {}), 2),
        t = n[0],
        r = t.currentOperand,
        a = t.previousOperand,
        o = t.operation,
      ...
      return (0, s.jsxs)("div", {
        ...
        children: [
          ...
          (0, s.jsx)("button", {
            className: "span-two",
            onClick: function () {
              return u({ type: d.CLEAR });
            },
            children: "AC",
          }),
          (0, s.jsx)("button", {
            onClick: function () {
              return u({ type: d.DELETE_DIGIT });
            },
            children: "DEL",
          }),
          (0, s.jsx)(f, { operation: "/", dispatch: u }),
          (0, s.jsx)(c, { digit: "7", dispatch: u }),
          (0, s.jsx)(c, { digit: "8", dispatch: u }),
          (0, s.jsx)(c, { digit: "9", dispatch: u }),
          (0, s.jsx)(f, { operation: "*", dispatch: u }),
          (0, s.jsx)(c, { digit: "4", dispatch: u }),
          (0, s.jsx)(c, { digit: "5", dispatch: u }),
          (0, s.jsx)(c, { digit: "6", dispatch: u }),
          (0, s.jsx)(f, { operation: "+", dispatch: u }),
          (0, s.jsx)(c, { digit: "1", dispatch: u }),
          (0, s.jsx)(c, { digit: "2", dispatch: u }),
          (0, s.jsx)(c, { digit: "3", dispatch: u }),
          (0, s.jsx)(f, { operation: "-", dispatch: u }),
          (0, s.jsx)(c, { digit: "0", dispatch: u }),
          (0, s.jsx)(c, { digit: ".", dispatch: u }),
          (0, s.jsx)("button", {
            className: "span-two",
            onClick: function () {
              return u({ type: d.EVALUATE });
            },
            children: "=",
          }),
        ],
    ...
    n.render(
      (0, s.jsx)(e.StrictMode, { children: (0, s.jsx)(g, {}) }),
      document.getElementById("root"),
    );
  })();
})();
//# sourceMappingURL=main.45f23075.js.map
